...
public class StateCountryNames {

	public static void main(String[] args) {
		readWriteStateCountryNames();
	}
	private static void readWriteStateCountryNames()
	{
		...
		try
		{
			fin=new FileInputStream("E:\\SG\\StateCountryNames.xlsx");
			...
			fout=new FileOutputStream("E:\\SG\\StateColourNames.xlsx");
			wb.write(fout);
		}catch(Exception e)
		{
			e.printStackTrace();
