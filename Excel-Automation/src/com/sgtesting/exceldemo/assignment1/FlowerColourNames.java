...
public class FlowerColourNames {

	public static void main(String[] args) {
		readWriteFlowerColourNames();
	}
	private static void readWriteFlowerColourNames()
	{
		...
		try
		{
			fin=new FileInputStream("E:\\SG\\FlowerColourNames.xlsx");
			...
			fout=new FileOutputStream("E:\\SG\\FlowerColourNames.xlsx");
			wb.write(fout);
		}catch(Exception e)
		{
			e.printStackTrace();
